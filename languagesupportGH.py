...
def app():
    ...
    # Navigation keys and translations
    if "translations" not in st.session_state:
        st.session_state["translations"] = {
            ...
            "motivation": dynamic_translate("Motivational Quotes", st.session_state["language"]),
        }
    ...
    navigation_keys = {
        ...
        "motivation": st.session_state["translations"]["motivation"],
    }
    ...
    selected_key = st.sidebar.radio(
        ...
        options=list(navigation_keys.keys()),
        format_func=lambda key: navigation_keys[key],
    )
   ...
   # Generate and Track SMART Goals Section
    ...
    elif st.session_state["navigation"]  == "motivation" :
